...
$csE = $conCero -> query("SELECT correoCrypt_R1a FROM nom035R1a WHERE correoCrypt_R1a = '$_GET[correoCrypt_R1a]'");
while ($dato = $csE->fetchArray()) {
	$correoCrypt = $dato['correoCrypt_R1a'];
}
		...
		<div class="hoja" style="margin-bottom: 10px;">
			...
			<div style="font-size: .93em; margin-top: 120px;">
				...
				<table>
					<tr>
						<td>
							<img src="soloqr.php?txtQr=http://corsec.com.mx/elfico/impreR01/enviarResultados.aspx?correoCrypt_R1a=<?php echo $idUsr;?>" style="width: 125px;" />
						</td>
						<td style="width: 300px;">
							<p>http://corsec.com.mx/elfico/impreR01/enviarResultados.aspx?correoCrypt_R1a=<?php echo $idUsr;?></p>
						</td>
					</tr>
				</table>
			</div>
