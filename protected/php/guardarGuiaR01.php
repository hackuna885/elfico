...
if (isset($_SESSION['usrCrypt']) && !empty($_SESSION['usrCrypt']) &&
	...
	$busCorreo = $con -> query("SELECT correoCrypt_R1a FROM nom035R1a WHERE correoCrypt_R1a = '$_SESSION[usrCrypt]'");

	while ($correoX = $busCorreo->fetchArray()) {
		$resBus = $correoX['correoCrypt_R1a'];
	}
...
$fechaHoraFinal = $fechaCap.' '.$horaCap;
	...
	$cs = $con -> query("INSERT INTO nom035R1a (p1_R1a,p2_R1a,p3_R1a,p4_R1a,p5_R1a,p6_R1a,p7_R1a,p8_R1a,p9_R1a,p10_R1a,p11_R1a,p12_R1a,p13_R1a,p14_R1a,p15_R1a,p16_R1a,p17_R1a,p18_R1a,p19_R1a,p20_R1a,p21_R1a,empresa_R1a,dirEmpresa_R1a,correo_R1a,correoCrypt_R1a,usrSexo_R1a,usrNumEmp_R1a,fechaHoraInicio_R1a,fechaHoraFinal_R1a,usrNombre_R1a) VALUES ('$opt1','$opt2','$opt3','$opt4','$opt5','$opt6','$opt7','$opt8','$opt9','$opt10','$opt11','$opt12','$opt13','$opt14','$opt15','$opt16','$opt17','$opt18','$opt19','$opt20','$opt21','$_SESSION[empresa]','$_SESSION[dirEmpresa]','$_SESSION[correo]','$_SESSION[usrCrypt]','$_SESSION[sexo]','$_SESSION[numEmp]','$_SESSION[fechaHoraIni]','$fechaHoraFinal','$_SESSION[nUsrCompleto]')");
	...
	<h3>El colaborador: '.$_SESSION['nUsrCompleto'].'</h3>
	...
	<br>
	<a href="http://www.corsec.com.mx/elfico/impreR01/enviarResultados.aspx?correoCrypt_R1a='.$_SESSION['usrCrypt'].'">http://www.corsec.com.mx/elfico/impreR01/enviarResultados.aspx?correoCrypt_R1a='.$_SESSION['usrCrypt'].'</a>
	<br>
	<br>
