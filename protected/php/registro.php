...
$numEmpleado = $txtN1.$txtN2.$txtN3.$txtN4.$txtN5.$txtN6;
	...
	$con = new SQLite3("../data/empleados.db") or die("Problemas para conectar");

	//BUSCA EL NUMERO DE EMPLEADO
	$cs = $con -> query("SELECT COUNT(NumEmpleado) AS cuantos FROM elfico WHERE NumEmpleado = '$numEmpleado'");
	...
	if ($cuantos > 0) {
		...
		$csDos = $con -> query("SELECT * FROM elfico WHERE NumEmpleado = '$numEmpleado'");
	 	...
	 	<div class="abs-center my-3">
	 		<form action="insertar/insRegistro.aspx" id="formulario" method="POST" class="form">
	 			...
	 			<div class="text-center col-12">
	 				<img class="img-fluid my-4" src="../img/logo_element_elfico.svg" alt="LOGO CORSEC">
				...
				<div class="form-group mb-3 col-12">
					...
					<input type="email" name="txtCorreo" class="form-control" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" id="email" placeholder="Correo Electrónico" required/>
				</div>
				<div class="form-group mb-3 col-12">
				...
				<br>
				<div class="form-group mb-3 col-12">
				<button type="submit" class="btn btn-light btn-lg form-control">Guardart <i class="fas fa-sign-in-alt"></i> <i class="fas fa-save"></i></button>
				</div>
				<div class="form-group mb-3 col-12">
