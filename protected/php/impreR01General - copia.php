...
$sumaCasos ='';
$resulSelector ='';
$idUsr = '7b2fdd8a7916cf5e5f9db042fdd21281';
...
$ocultarUno = '';
	...
	$busCorreo = $con -> query("SELECT * FROM nom035R1a WHERE correoCrypt_R1a = '$idUsr'");
	...
	while ($dato = $busCorreo->fetchArray()) {
		...
		$correoCrypt_R1a = $dato['correoCrypt_R1a'];
		...
		<div class="hoja" style="margin-bottom: 10px;">
			...
			<div style="font-size: .93em; margin-top: 120px;">
				...
				<table>
					<tr>
						<td>
							<img src="soloqr.php?txtQr=http://corsec.com.mx/elfico/impreR01/enviarResultados.aspx?correoCrypt_R1a='.$idUsr.'" style="width: 125px;" />
						</td>
						<td style="width: 300px;">
							<p>http://corsec.com.mx/elfico/impreR01/enviarResultados.aspx?correoCrypt_R1a='.$idUsr.'</p>
						</td>
					</tr>
				</table>
			</div>
