...
<head>
	...
	<title>Reporte NOM-035 G1</title>
	<style>
		@media print {
			.hoja{
...
date_default_timezone_set('America/Mexico_City');
	...
	$conCero = new SQLite3("../data/cuestionarios.db") or die("Problemas para conectar!");

	$cs = $conCero -> query("SELECT * FROM nom035R1a LIMIT 100");

	while ($datoX = $cs->fetchArray()) {

		$correoCriotOriginal = $datoX['correoCrypt_R1a']; 

$correoCrypt = '';
$sumaCasos ='';
$resulSelector ='';
$idUsr = $correoCriotOriginal;
